...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: isZh
      ? '伟伟拉链隐私政策。了解我们如何收集、使用和保护您的信息。'
      : 'Privacy Policy for Weiwei Zipper. Learn how we collect, use, and protect your information.',
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            {isZh
              ? '访问或使用本网站，即表示您同意本政策所述的数据处理方式。'
              : 'By using our website, you agree to the data practices described here.'}
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-3">
            ...
            <li>
              ...
              {isZh
                ? ' — 国家/地区、产品需求、拉链品类、规格、数量及交期'
                : ' — country, product needs, zipper type, size details, quantities, and delivery timelines'}
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>{isZh ? '回复拉链询盘并提供配套建议' : 'Respond to zipper inquiries and provide matching suggestions'}</li>
            <li>{isZh ? '处理和履行订单（打样、排产、发货）' : 'Process and fulfill orders (sampling, production scheduling, shipping)'}</li>
            <li>{isZh ? '提供售后支持（返单、补单与问题追踪）' : 'Provide after-sales support (repeat orders, replenishment, and issue follow-up)'}</li>
