  ...
  return (
    <div className="container mx-auto px-4 py-10 sm:py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-base sm:text-lg text-gray-600 mb-6">{solutionsPageContent.subtitle}</p>
        ...
        <section className="mt-12 bg-gray-50 rounded-lg p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">{solutionsPageContent.process.title}</h2>
        ...
        <div className="mt-10 text-center">
          ...
          <Link href="/quote" className="w-full sm:w-auto bg-blue-800 text-white px-8 py-3 rounded font-semibold hover:bg-blue-900 transition-colors inline-block">
