...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: isZh
      ? '伟伟拉链服务条款。了解我们网站的使用条件、产品信息、知识产权及交易条款。'
      : 'Terms of Service for Weiwei Zipper. Understand our website usage conditions, product information, intellectual property, and transaction terms.',
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            {isZh
              ? `欢迎访问${companyName}官方网站。`
              : `Welcome to the website of ${companyName}.`}
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            {isZh
              ? '网站内容仅供信息参考和业务沟通。您可以浏览内容并发送询盘。'
              : 'Website content is for information and business communication only. You may browse content and send inquiries.'}
          </p>
          <p className="text-gray-600 leading-relaxed mb-3">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>{isZh ? '产品图片仅供参考，当前页面重点用于展示品类和规格信息' : 'Product images are for reference only; the current pages focus on category and size communication'}</li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            {isZh
              ? '标准条款：订单确认后 30% 定金，出货前结清尾款。价格不含银行手续费。'
              : 'Standard terms: 30% deposit after order confirmation, balance before shipment. Prices exclude bank charges.'}
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-3">
            <li>{isZh ? '常规项目：按实际排产回复' : 'Standard projects: confirmed according to the live production schedule'}</li>
            <li>{isZh ? '打样与大货时间会根据规格复杂度调整' : 'Sample and bulk timing depends on complexity'}</li>
          </ul>
          <h3 className="text-base font-semibold text-gray-800 mb-2">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            {isZh
              ? '按拉链品类和数量安排常规内外包装，适合样品与大货发出。'
              : 'Packaging is arranged according to zipper type and quantity for both samples and bulk shipment.'}
          </p>
          <p className="text-gray-600 leading-relaxed">
            {isZh
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            {isZh
              ? '所有产品会按确认后的规格执行，重点控制规格一致性与批次稳定性。'
              : 'All products follow the confirmed specifications, with focus on consistency across batches.'}
          </p>
          <h3 className="text-base font-semibold text-gray-800 mb-2">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            {isZh
              ? '技术建议和产品推荐仅供参考。最终的拉链选型应以实际项目需求为准。对因使用本网站导致的任何损失，本公司不承担责任。'
              : 'Technical advice and recommendations are for reference only. Final zipper selection should be based on your actual project requirements. We are not liable for damages from website use.'}
          </p>
        </section>
