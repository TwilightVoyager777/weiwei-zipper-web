  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-12">{aboutContent.subtitle}</p>

        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{aboutContent.story.title}</h2>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{aboutContent.capabilities.title}</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{aboutContent.mission.title}</h2>
