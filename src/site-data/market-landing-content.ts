...
const yiwuZipperLandingZh = {
  ...
  visit: {
    title: '在义乌国际商贸城找到我们',
    note: '摊位位于国际商贸城三区的拉链与服装辅料区域。在义乌现场采购的客户欢迎到摊位当面沟通；提前告知关注的规格与结构，我们可以先备好对应的样品。',
    addressLabel: '摊位地址',
    hoursLabel: '营业时间',
    sinceLabel: '经营起始年份',
    contactLabel: '到店前联系',
...
const yiwuZipperLandingEn = {
  ...
  visit: {
    ...
    note: 'The booth sits in District 3, the zipper and garment accessory section. Buyers sourcing in Yiwu are welcome to come by in person; telling us beforehand which sizes and structures you are looking at lets us have the matching samples ready.',
    addressLabel: 'Booth address',
    hoursLabel: 'Business hours',
    sinceLabel: 'Supplying zippers since',
    contactLabel: 'Before you visit',
...
const yiwuZipperLandingEs = {
  ...
  visit: {
    ...
    note: 'El puesto está en el Distrito 3, la zona de cremalleras y accesorios para prendas. Si está comprando en Yiwu, puede visitarnos en persona; si nos indica antes qué tamaños y estructuras le interesan, podemos preparar las muestras correspondientes.',
    addressLabel: 'Dirección del puesto',
    hoursLabel: 'Horario de atención',
    sinceLabel: 'Suministrando cremalleras desde',
    contactLabel: 'Antes de visitarnos',
...
const yiwuZipperLandingAr = {
  ...
  visit: {
    ...
    note: 'يقع الجناح في المنطقة الثالثة، قسم السحابات ومستلزمات الملابس. إذا كنت تشتري في ييوو فنرحب بزيارتك شخصيا؛ وإذا أخبرتنا مسبقا بالمقاسات والهياكل التي تهمك يمكننا تجهيز العينات المناسبة.',
    addressLabel: 'عنوان الجناح',
    hoursLabel: 'ساعات العمل',
    sinceLabel: 'نورد السحابات منذ',
    contactLabel: 'قبل الزيارة',
...
const yiwuZipperLandingRu = {
  ...
  visit: {
    ...
    note: 'Стенд находится в районе 3, в секции молний и швейной фурнитуры. Если вы закупаете в Иу, приходите к нам лично; сообщите заранее, какие размеры и конструкции вас интересуют, и мы подготовим соответствующие образцы.',
    addressLabel: 'Адрес стенда',
    hoursLabel: 'Часы работы',
    sinceLabel: 'Поставляем молнии с',
    contactLabel: 'Перед визитом',
