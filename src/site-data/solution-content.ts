...
const solutionsPageContentEs = {
  metadata: {
    title: 'Soluciones',
    description: 'Descubra cómo Weiwei Zipper apoya el muestreo, la compra al por mayor y el suministro para reposiciones para que los proyectos avancen con más fluidez en confirmación, cotización y entrega.',
  },
  title: 'Soluciones',
  ...
  introText: 'En Weiwei Zipper, una solución no consiste solo en recomendar un tipo de cremallera. Organizamos nuestro apoyo alrededor de las etapas en las que los clientes suelen necesitar una coordinación más clara: selección inicial y desarrollo, confirmación de muestras, compras al por mayor y reposiciones posteriores. El objetivo es aclarar antes la dirección del material, el tamaño, la estructura, la longitud, el color, la combinación del cursor y la planificación de entrega para que la comunicación sea más eficiente durante todo el proyecto.',
  ...
  items: [
    ...
    },
    {
      ...
      imagePath: '/products/pf.png',
      imageAlt: 'Visual de detalle de producto de cremallera',
      description: 'Para pedidos regulares y necesidades de compra estables, apoyamos una confirmación más clara y una coordinación más consistente en volumen.',
      detail: 'Una vez que el proyecto entra en la fase de compra al por mayor, los clientes suelen centrarse más en la precisión de las especificaciones, la consistencia del color, la combinación del cursor y la estabilidad de la entrega. Weiwei Zipper ayuda a organizar esos puntos clave alrededor de tamaños comunes y registros previamente confirmados para que el proyecto entre en planificación con una base de compra más clara y menor costo de confirmación.',
      points: ['Los planes de compra pueden organizarse alrededor de tamaños comunes y registros históricos', 'Ayuda a confirmar con antelación longitud, color, cursores y detalles de embalaje', 'Adecuado para prendas, bolsos, calzado y otros proyectos de uso final habitual', 'Facilita la conexión entre la confirmación de muestras y el pedido al por mayor con la programación de producción'],
    },
    {
      title: 'Reposiciones y suministro continuo',
      imagePath: '/products/fd.jpeg',
      imageAlt: 'Visual de detalle de producto de cremallera',
      description: 'Para reposiciones, programas recurrentes y cooperación a largo plazo, ayudamos a mantener registros claros de especificaciones y continuidad de suministro.',
      detail: 'En los pedidos repetidos, la necesidad real no suele ser empezar la confirmación desde cero, sino continuar con la misma lógica de tamaño, color y estructura ya utilizada. Weiwei Zipper pone más énfasis en mantener organizadas las soluciones comunes, los registros de confirmación y las especificaciones frecuentes para que las reposiciones y los proyectos de suministro a largo plazo mantengan una mejor eficiencia de comunicación y una entrega más estable.',
      points: ['Adecuado para proyectos continuos con especificaciones fijas o programas de producto recurrentes', 'Facilita las reposiciones sobre la base de confirmaciones anteriores', 'Mejora la eficiencia de comunicación y la continuidad en fases de repetición', 'Encaja con modelos de cooperación a largo plazo que requieren suministro estable y coordinado'],
    },
  ],
  process: {
    title: 'Proceso de cooperación',
    steps: [
      { title: 'Revisión de requisitos', description: 'Comenzamos revisando uso previsto, dirección de material, tamaño, estructura, longitud y color.' },
      { title: 'Confirmación de solución', description: 'Según el tipo de proyecto y los tamaños comunes, definimos con más precisión la dirección adecuada en metal, resina o nylon.' },
      { title: 'Avance de muestras', description: 'Las muestras se confirman con cartas, fotos, muestras antiguas o registros existentes para crear una base de cotización y compra.' },
      { title: 'Entrega en volumen', description: 'Después de confirmar muestras y especificaciones, el proyecto puede pasar a programación, producción y suministro para reposiciones posteriores.' },
    ],
  },
  ctaText: 'Si su proyecto ya está claro, puede compartir tamaño, longitud, color, cantidad y aplicación para que avancemos más rápidamente hacia la confirmación de la solución y la cotización.',
