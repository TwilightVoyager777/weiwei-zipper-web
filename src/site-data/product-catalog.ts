  ...
  resinZippers: {
    ...
    applications: {
      ...
      items: [
        ...
        {
          title: '休闲服饰拉链',
          description: '适合需要颜色匹配和日常穿着手感平衡的常规款式，可按前中、口袋或局部结构确认闭口、开口或双开方式。',
        },
        {
          title: '鞋帽配件拉链',
    ...
    selectionGuide: {
      ...
      factors: [
        ...
        {
          title: '再定规格与结构',
          description: '可先结合前中、口袋或局部装饰位置确认 3 号、5 号或 8 号，以及闭口、开口或双开方式。',
        },
        {
          title: '最后确认长度与拉头',
  ...
  nylonZippers: {
    ...
    applications: {
      ...
      items: [
        ...
        {
          title: '轻便外套拉链',
          description: '注重拉合顺手和反复使用稳定性，可按成衣版型匹配开口或双开结构。',
        },
        {
          title: '日常背包拉链',
...
export const productItems: Record<ProductSlug, ProductItemContent> = {
  ...
  'resin-zipper-roll-3-5-8': {
    ...
    category: 'resinRolls',
    name: '树脂码装（3 / 5 / 8 号）',
    description: '3 号 / 5 号 / 8 号树脂码装链条，按卷供货、按需裁切，适合后续装头与定长加工。牙型、颜色与织带方向可按色卡确认，起订量与价格另行报价。',
    overview: '树脂码装主要用于后续裁切、装头与成品加工，不是长度已经固定的成品拉链。伟伟拉链围绕 3 号、5 号、8 号常用规格提供树脂码装基础配套，便于客户先确认牙型、颜色与织带方向，再按实际长度安排后道加工。',
  ...
  'nylon-zipper-roll-3-5-8': {
    ...
    category: 'nylonRolls',
    name: '尼龙码装（3 / 5 / 8 号）',
    description: '3 号 / 5 号 / 8 号尼龙码装链条，按卷供货、按需裁切，适合服装、箱包与防晒衣项目的定长加工。规格与配色可按色卡确认，起订量与价格另行报价。',
    overview: '尼龙码装主要用于后续裁切、装头与成品加工，适合需要兼顾顺滑度和长度灵活性的常见项目。伟伟拉链围绕 3 号、5 号、8 号常用规格提供尼龙码装基础配套，便于客户先确认规格方向，再结合长度、拉头与后道加工方式推进打样或报价。',
  ...
  'metal-zipper-roll-3-5-8': {
    ...
    category: 'metalRolls',
    name: '金属码装（3 / 5 / 8 号）',
    description: '3 号 / 5 号 / 8 号金属码装链条，不带上下止与插管，按卷供货由客户自行裁切装头。牙色、织带与拉头可按色卡确认，起订量与价格另行报价。',
    overview: '金属码装主要用于后续裁切、装头与成品加工，适合需要保留金属质感并灵活控制长度的项目。伟伟拉链围绕 3 号、5 号、8 号常用规格提供金属码装基础配套，便于客户先确认牙色、织带与拉头方向，再按实际款式安排后道加工。',
...
const categoryContentEn: Record<ProductCategory, ProductCategoryContent> = {
  resinZippers: {
    ...
    specifications: {
      ...
      moq: 'From 1,000 pieces, colors mixable',
  ...
  resinRolls: {
    ...
    keyFeatures: ['Supplied without top and bottom stops or insertion parts, so it becomes a finished zipper only after cutting and slider fitting', 'Quoted by the roll, separately from the 1,000-piece minimum that applies to finished zippers', 'Length is decided by how you cut it, not by a fixed finished length', 'Light in weight with a wide color range, which suits series development for apparel, children\'s wear and light accessories'],
    applications: {
      title: 'Typical Uses',
      items: [
        {
        ...
        {
          title: 'Stocking for a series',
          description: 'Resin teeth cover a wide color range, so material can be secured by color family during development and cut to length once the styles are set.',
        },
      ],
    },
    selectionGuide: {
      ...
      factors: [
        ...
        {
          title: 'Then pick the material',
          description: 'Resin roll is lighter and more flexible on color, which suits apparel, children\'s wear and light accessories; choose metal roll when the style needs a hardware look or has to take more load.',
        },
        {
          title: 'Last, confirm size and roll length',
          description: 'Common sizes are 3, 5 and 8, at a closed chain width of about 3, 5 and 8 mm. Please confirm the length per roll with your enquiry so we can arrange it around your volume.',
...
const productItemsRu: Record<ProductSlug, ProductItemContent> = {
  ...
  'metal-no-5-closed-end-zipper': {
    ...
    overview: 'Металлическая неразъемная молния подходит для моделей, где нужна неразъемная конструкция вместе с более выраженным металлическим ощущением. Weiwei Zipper помогает координировать длину, цвет зуба, тесьму и комбинацию бегунка, чтобы клиент сначала подтвердил образец, а затем перешел к оптовой закупке и повторным заказам.',
